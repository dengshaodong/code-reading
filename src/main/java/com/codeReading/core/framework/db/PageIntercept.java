...
public class PageIntercept implements Interceptor {
	...
	private void setPageParameter(String sql, Connection connection, MappedStatement mappedStatement, BoundSql boundSql, PageBean page) throws Exception {
	...
	private String rewritePageSql(String sql, PageBean page) {
	...
	private String getMysqlPageSql(String sql, PageBean page) {
		return getPostgresPageSql(sql, page); // mysql与pgsql兼容
	}

	private String getPostgresPageSql(String sql, PageBean page) {
