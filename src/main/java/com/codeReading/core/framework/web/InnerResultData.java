...
public class InnerResultData<T> {
	...
	public InnerResultData(){
		this(Constant.SUCCESS_CODE);
	}
	
	public InnerResultData(String retCode){
		this(retCode, Constant.SUCCESS_REASON);
	}
	public InnerResultData(String retCode, String reason){
		this(retCode, reason, System.currentTimeMillis());
	}
	public InnerResultData(String retCode, String reason, Long time){
